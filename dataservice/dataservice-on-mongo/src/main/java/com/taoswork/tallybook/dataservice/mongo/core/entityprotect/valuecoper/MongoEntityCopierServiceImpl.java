package com.taoswork.tallybook.dataservice.mongo.core.entityprotect.valuecoper;
...
public class MongoEntityCopierServiceImpl implements EntityCopierService {
    ...
    public <T extends Persistable> T makeSafeCopyForQuery(CopierContext copierContext, T rec) throws ServiceException {
        return rec;
//        EntityCopier copier = new EntityCopier(copierContext.classMetaAccess,
//                copierContext.externalReference, entityCopierPool);
//        try {
