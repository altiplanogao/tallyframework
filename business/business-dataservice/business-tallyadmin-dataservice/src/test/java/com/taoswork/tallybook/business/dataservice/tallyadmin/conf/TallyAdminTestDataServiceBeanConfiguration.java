...
public class TallyAdminTestDataServiceBeanConfiguration extends TallyAdminDataServiceBeanConfiguration {

    public TallyAdminTestDataServiceBeanConfiguration() {
