...
public class EntityActionPaths {
    ...
    public final static class EntityUris{
        ...
        public static String uriTemplateForAction(String entityName, EntityAction action){
            ...
            switch (action){
                case CREATE: useFullTemplate = L_ENTITY_CREATE; break;
                case READ: useFullTemplate = L_ENTITY_READ; break;
                case UPDATE: useFullTemplate = L_ENTITY_UPDATE; break;
                case DELETE: useFullTemplate = L_ENTITY_DELETE; break;
                case QUERY: useFullTemplate = L_ENTITY_QUERY; break;

                case INFO: useFullTemplate = L_ENTITY_INFO; break;
                case SELECT: useFullTemplate = L_ENTITY_SELECT; break;
                case TYPEAHEAD: useFullTemplate = L_ENTITY_TYPEAHEAD; break;
                default: throw new NotImplementedException("Not implemented for " + action);
            }
...
//        private static final String ENTRY_SELECT = "/{entity}/{id}/{field}/{add_or_item}/{entry_field}/select";
        ...
        public static String uriTemplateForCollectionAction(String fieldName, CollectionAction action){
            String useFullTemplate = null;
            switch (action){
                case CREATE: useFullTemplate = L_BEAN_FIELD_ITEM_CREATE; break;
                case READ: useFullTemplate = L_BEAN_FIELD_ITEM_READ; break;
                case UPDATE: useFullTemplate = L_BEAN_FIELD_ITEM_UPDATE; break;
                case DELETE: useFullTemplate = L_BEAN_FIELD_ITEM_DELETE; break;
                case QUERY: useFullTemplate = L_BEAN_FIELD_ITEM_QUERY; return "";
                case REORDER: useFullTemplate = L_BEAN_FIELD_ITEM_REORDER; break;
                default: throw new NotImplementedException("Not implemented for " + action);
            }
