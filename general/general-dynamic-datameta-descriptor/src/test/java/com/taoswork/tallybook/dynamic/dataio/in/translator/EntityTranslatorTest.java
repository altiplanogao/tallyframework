...
public class EntityTranslatorTest {
    static IClassMetadataAccess classMetadataAccess = new IClassMetadataAccess() {
        ...
        public IClassMetadata getClassMetadata(Class<?> entityType, boolean withHierarchy) {
            return metadataService.generateMetadata(entityType, null, true);
        }
